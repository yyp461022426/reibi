(function ($) {
  ...
  var ella = {
    ...
    init: function () {
      ...
      this.hideSizechart();
      this.initMainPageProOption();
      this.initDropdownCartForHeaderDefault();
      this.initMouseOverCover();
      this.initActiveCountdown();
      this.initSearchRecord();
      this.initTextareaCount()
      this.initMainPageSlider();
      if ($("[custom-link-btn]").length > 0) {
        this.initCustomLinkBtn();
      }
      ...
      if (body.hasClass("template-product")) {
        ...
        this.initProductMoreview(
          $("[data-more-view-product] .product-img-box")
        );
        this.initZoom();
    ...
    showPopupStoreAvailability: function () {
      ...
      body.on("click", function (event) {
        if (
          $(event.target).closest(".store-availabilities-modal").length === 0 &&
          $(event.target).closest(".store-availability-information__button")
            .length === 0
        ) {
          // e.preventDefault();
          body.removeClass("show_store_availability");
    ...
    showPopupShare: function () {
      ...
      body.on("click", function (event) {
        if (
          $(event.target).closest(".wrapper-social-popup").length === 0 &&
          $(event.target).closest(".icon-share").length === 0
        ) {
    ...
    copyText: function () {
      ...
      body
        .off("click.copyText", ".social-garment-link")
        .on("click.copyText", ".social-garment-link", function (e) {
          if (check_copy == false) {
          ...
          get nextArrow() {
            if (
              ...
              return (this.nextArrow =
                '<button type="button" aria-label="Next Product" class="slick-next"><svg viewBox="0 0 50 50"><path d="M 11.957031 13.988281 C 11.699219 14.003906 11.457031 14.117188 11.28125 14.308594 L 1.015625 25 L 11.28125 35.691406 C 11.527344 35.953125 11.894531 36.0625 12.242188 35.976563 C 12.589844 35.890625 12.867188 35.625 12.964844 35.28125 C 13.066406 34.933594 12.972656 34.5625 12.71875 34.308594 L 4.746094 26 L 48 26 C 48.359375 26.003906 48.695313 25.816406 48.878906 25.503906 C 49.058594 25.191406 49.058594 24.808594 48.878906 24.496094 C 48.695313 24.183594 48.359375 23.996094 48 24 L 4.746094 24 L 12.71875 15.691406 C 13.011719 15.398438 13.09375 14.957031 12.921875 14.582031 C 12.753906 14.203125 12.371094 13.96875 11.957031 13.988281 Z"></path></svg></button>');
            } else {
              return (this.nextArrow =
                '<button type="button" aria-label="Next Product" class="slick-next"><svg viewBox="0 0 478.448 478.448" class="icon icon-chevron-right" id="icon-chevron-right"><g><g><polygon points="131.659,0 100.494,32.035 313.804,239.232 100.494,446.373 131.65,478.448 377.954,239.232"></polygon></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg></button>');
            }
          },
          get prevArrow() {
            if (
              ...
              return (this.prevArrow =
                '<button type="button" aria-label="Previous Product" class="slick-prev"><svg viewBox="0 0 50 50"><path d="M 11.957031 13.988281 C 11.699219 14.003906 11.457031 14.117188 11.28125 14.308594 L 1.015625 25 L 11.28125 35.691406 C 11.527344 35.953125 11.894531 36.0625 12.242188 35.976563 C 12.589844 35.890625 12.867188 35.625 12.964844 35.28125 C 13.066406 34.933594 12.972656 34.5625 12.71875 34.308594 L 4.746094 26 L 48 26 C 48.359375 26.003906 48.695313 25.816406 48.878906 25.503906 C 49.058594 25.191406 49.058594 24.808594 48.878906 24.496094 C 48.695313 24.183594 48.359375 23.996094 48 24 L 4.746094 24 L 12.71875 15.691406 C 13.011719 15.398438 13.09375 14.957031 12.921875 14.582031 C 12.753906 14.203125 12.371094 13.96875 11.957031 13.988281 Z"></path></svg></button>');
            } else {
              return (this.prevArrow =
                '<button type="button" aria-label="Previous Product" class="slick-prev"><svg viewBox="0 0 370.814 370.814" class="icon icon-chevron-left" id="icon-chevron-left"><g><g><polygon points="292.92,24.848 268.781,0 77.895,185.401 268.781,370.814 292.92,345.961 127.638,185.401"></polygon></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg></button>');
            }
          },
          speed: 1000,
          responsive: [
        ...
        $("[data-slider-sub-collection]").slick({
          ...
          get prevArrow() {
            if (
              ...
              return (this.prevArrow =
                '<button type="button" aria-label="Previous" class="slick-prev"><svg viewBox="0 0 50 50"><path d="M 11.957031 13.988281 C 11.699219 14.003906 11.457031 14.117188 11.28125 14.308594 L 1.015625 25 L 11.28125 35.691406 C 11.527344 35.953125 11.894531 36.0625 12.242188 35.976563 C 12.589844 35.890625 12.867188 35.625 12.964844 35.28125 C 13.066406 34.933594 12.972656 34.5625 12.71875 34.308594 L 4.746094 26 L 48 26 C 48.359375 26.003906 48.695313 25.816406 48.878906 25.503906 C 49.058594 25.191406 49.058594 24.808594 48.878906 24.496094 C 48.695313 24.183594 48.359375 23.996094 48 24 L 4.746094 24 L 12.71875 15.691406 C 13.011719 15.398438 13.09375 14.957031 12.921875 14.582031 C 12.753906 14.203125 12.371094 13.96875 11.957031 13.988281 Z"></path></svg></button>');
            } else {
              return (this.prevArrow =
                '<button type="button" aria-label="Previous" class="slick-prev"><svg viewBox="0 0 370.814 370.814" class="icon icon-chevron-left" id="icon-chevron-left"><g><g><polygon points="292.92,24.848 268.781,0 77.895,185.401 268.781,370.814 292.92,345.961 127.638,185.401"></polygon></g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg></button>');
            }
          },
          speed: 1000,
          responsive: [
    ...
    productCartslider: function () {
      if (
        $("[data-product-cart-slider]").length &&
        !$("[data-product-cart-slider]").hasClass("slick-slider")
      ) {
        $("[data-product-cart-slider]").slick({
          ...
          get nextArrow() {
            if (
              ...
              return (this.nextArrow =
                '<button type="button" aria-label="Next Product" class="slick-next"><i class="fa fa-angle-right"></i></button>');
            }
          },
          get prevArrow() {
            if (
              ...
              return (this.prevArrow =
                '<button type="button" aria-label="Previous Product" class="slick-prev"><i class="fa fa-angle-left"></i></button>');
            }
          },
          speed: 1000,
        });
    ...
    closeAnnouncementBar: function () {
      if ($(".home-announcement-sections").length) {
        var announcementEml = $(".home-announcement"),
          closeannouncementElm = announcementEml.find(
        ...
        closeannouncementElm
          .off("click.closeAnnouncement")
          .on("click.closeAnnouncement", function (e) {
            e.preventDefault();
            e.stopPropagation();
            announcementEml.remove();
    ...
    initToggleGlobe: function () {
      ...
      body.on("click", function (e) {
        if (
          $(".item-location").hasClass("active") &&
          $(event.target).closest(".item-location").length === 0
        ) {
          e.preventDefault();
    ...
    initToggleMuiltiLangCurrency: function () {
      ...
      if ($(".lang-currency-groups-8").length) {
        ...
        $(document).on("click", function (e) {
          ...
          if (
            $(".lang-currency-groups-8 ").hasClass("show") &&
            !slideshow.has(e.target).length &&
            $(event.target).closest(".lang-currency-groups-8 ").length === 0
          ) {
            $(".lang-currency-groups-8 ").removeClass("show");
          }
        });
          ...
          infiniteScrollingLinkSlt
            ...
            .on("click.showMoreProduct", function (e) {
              if (!$(this).hasClass("view-all-collection")) {
                ...
                var collection_handle = $(this).attr("data-collection"),
                ...
                if (!$(this).hasClass("disabled")) {
                  ...
                  let url =
                    ...
                    "?page=" +
                    page;
                  ella.doAjaxInfiniteScrollingGetContentForNewArrivals(url);
                  return;
    ...
    doAjaxInfiniteScrollingGetContentForNewArrivals(url) {
      ...
      $.ajax({
        ...
        success: function (data) {
          console.log(data);
          ella.ajaxInfiniteScrollingMapDataForNewArrivals(data);
        ...
        complete: function () {
          ella.hideLoading();
          var number_count = 0;
          var number_label_new = $(
            ".product-collection .grid-item .product-label"
          ).data("label-new-number");
    ...
    ajaxInfiniteScrollingMapDataForNewArrivals(data) {
      var collectionTemplate = $(".new-arrivals-product"),
        currentProductColl = collectionTemplate.find(
          ".widget-product .products-grid"
        ),
        currentProductCount = collectionTemplate.find(
          ".infinite-scrolling-homepage a"
        ),
        newCollectionTemplate = $(data).find(".collection-template"),
        newProductColl = newCollectionTemplate.find(".product-collection"),
        openProductViewCount = newCollectionTemplate.find(
          ".btn-product-show-more"
        ),
        changeProductViewCount = `<a class="btn btn--big btn-product-change-show-more show-more">close</a>`;
      newProductItem = newProductColl.children(".grid-item").not(".banner-img");
      let addColl = newProductItem.filter((index) => index >= 10);
      currentProductCount.replaceWith(changeProductViewCount);
      let changeBtn = collectionTemplate.find(".btn-product-change-show-more");
      changeBtn.on("click.changeShowMore", function () {
        let ProductColl = collectionTemplate.find(
          ".widget-product .products-grid"
        );
        const hideItem = ProductColl.children(".grid-item")
          .not(".banner-img")
          .slice(10);
        if (changeBtn.hasClass("show-more")) {
          hideItem.hide();
          ...
          if ($(data).length == limit && length < 50) {
            ...
            if (totalProduct > 50) {
              $(e.currentTarget)
                ...
                .attr("href", window.router + "/collections/" + url)
      ...
      featuredProduct.each(function () {
        ...
        if (productGrid.not(".slick-initialized")) {
          productGrid.slick({
            ...
            get vertical() {
              if (
                productGrid.hasClass("verticle") &&
                $(".relate-verticle").length
              ) {
          ...
          if (!self.hasClass("ajax-loaded")) {
            ...
            if (top < window.innerHeight + 10) {
              $.ajax({
                ...
                complete: function () {
                  if (
                    self.attr("data-featured-products-section") == undefined &&
                    self.attr("data-featured-products-section-2") == undefined
                  ) {
                    return;
                  }
                  if (layout == "carousel") {
                    ...
                    if (window.innerWidth < 1200) {
                      self.on("afterChange", function (event, slick) {
                        ...
                        $(".product-item[data-product-id]").each(function (
                          i,
                          el
                        ) {
                          var self = $(this);
                          if (isElementVisible($(el), -100)) {
                            var $product = $(this);
                            if (
                              !$product[0].hasAttribute("data-json-product")
                            ) {
                              ...
                              get slidesToShow() {
                                if (
                                  self
                                    ...
                                    .hasClass("layout_style_7") &&
                                  self.hasClass("col-md-12")
                                ) {
                                  return (this.slidesToShow = 2);
                                } else {
                                  if (gridItemWidth >= 4) {
                          ...
                          },
                          {
                            ...
                            settings: {
                              ...
                              get slidesToShow() {
                                if (gridItemWidth >= 3) {
                                  if (
                                    self.hasClass("layout_style_5") ||
                                    self.hasClass("layout_style_6")
                                  ) {
                                    return (this.slidesToShow = 2);
                                  } else {
                                    return (this.slidesToShow = 3);
          ...
          self.slick({
            ...
            get nextArrow() {
              if (
                ...
                return (this.nextArrow =
                  '<button type="button" aria-label="Next" class="slick-next"><i class="fa fa-angle-right"></i></button>');
              }
            },
            get prevArrow() {
              if (
                ...
                return (this.prevArrow =
                  '<button type="button" aria-label="Previous" class="slick-prev"><i class="fa fa-angle-left"></i></button>');
              }
            },
            responsive: [
              {
    ...
    popSearchBox: function () {
      this.initPopSearchBox($("[data-search-pop-toggle]"), "search-pop-show");
    },

    initPopSearchBox: function (iconUser, sltShowUser) {
      if (iconUser.length && iconUser.is(":visible")) {
        iconUser.off("click").on("click", function (e) {
          e.preventDefault();
          e.stopPropagation();

          html.toggleClass(sltShowUser);
        });
      }
    },
    ...
    dropdownCart: function () {
      ...
      this.initRemoveItemDropdownCart();
      this.initDiscountBox();
      this.initNumberInput(dropdownCart, ella.dropdownCartQuantityChange);
    },
    ...
    initDropdownCartMobile: function () {
      var headerMb = $(
          ".header-mb, [data-cart-header-parallax], [data-cart-header-02], [data-cart-header-04], [data-cart-header-05], [data-cart-header-supermarket], [data-cart-sidebar], .halo-sticky-toolbar-mobile"
        ),
        ...
        cartIcon
          ...
          .on("click.toogleDropdownCart", function (e) {
            ...
            $([document.documentElement, document.body]).animate(
              {
                scrollTop:
                  $(".wrapper-cart-template").offset().top -
                  $(".main-menu").outerHeight(),
              },
              500
            );
          });
    ...
    initRemoveItemDropdownCart: function () {
    ...
    updateDropdownCartOnMainCartPage: function (cart, isFromDiscountApply, params) {
      // console.log(cart);
      // 折扣码相关
      $(".disct-code-box .no-match-disct").hide();
      if (
        cart.cart_level_discount_applications.length > 0 &&
        $("[data-cart-discount-wrapper]").length
      ) {
        var cartDiscounts = cart.cart_level_discount_applications;
        var title =
          cartDiscounts[0].title || cartDiscounts[0].discount_application.title; // 返回的cart结构存在差异不一样
        var total_discount =
          cartDiscounts[0].total_allocated_amount ||
          cartDiscounts[0].discount_application.total_allocated_amount;
        $("[data-cart-discount-wrapper]").show();
        $(".groued-saves").show();
        $("[data-cart-discount-title]").text(title);
        $("[data-cart-discount-amount]").html(
          Shopify.formatMoney(total_discount, window.money_format)
        );
        
        if(isFromDiscountApply && params && params !== 'NULL'){
          let discountApplied = false;
          let originalCode = params
          if (originalCode && title.toUpperCase() === originalCode) {
            discountApplied = true;
          }
          if(discountApplied){
            $(".disct-code-box .no-match-disct").hide();
          } else {
            $(".disct-code-box .no-match-disct").show();
          }
        }
        ...
        $(".groued-saves").hide();
        if (isFromDiscountApply) {
          $(".disct-code-box .no-match-disct").show();
        }
      }
      //价格计算相关
      $(".total .original-total-price").html(
        Shopify.formatMoney(cart.original_total_price, window.money_format)
      );
      $(".groued-info .total .total-price").html(
        Shopify.formatMoney(cart.items_subtotal_price, window.money_format)
      );
      $(".grouped-bottom .total .total-price").html(
        Shopify.formatMoney(cart.total_price, window.money_format)
      );
      $("[data-cart-count]").text(cart.item_count);
      if (cart.original_total_price == cart.items_subtotal_price) {
        $(".total .original-total-price").hide();
      } else {
        $(".total .original-total-price").show();
      }
      // 来自删除按钮的代码迁移
      $(".total .price").html(
        Shopify.formatMoney(cart.total_price, window.money_format)
      ...
      if (
        $("#gift-wrapping").length &&
        productId == $("#gift-wrapping").data("gift-id")
      ) {
        $("#is-a-gift").show();
      }
      ...
      // 渲染列表
      let card_items = cart.items;
      let card_lists = $(".cart-list").find(".cart-product-item");
      card_lists.each(function (i, el) {
        $(el)
          .find(".price-box .original-price")
          .html(
            Shopify.formatMoney(
              card_items[i].original_price,
              window.money_format
            )
          );
        $(el)
          .find(".price-box .discounted_price .disc-price")
          .html(
            Shopify.formatMoney(card_items[i].final_price, window.money_format)
          );
        $(el)
          .find(".cart--total .line-price")
          .html(
            Shopify.formatMoney(
              card_items[i].final_line_price,
              window.money_format
            )
          );

        let item_disct_str = "";
        cart.items[i].line_level_discount_allocations.map((item) => {
          item_disct_str += `
            <li class="pro-disct">
              <svg class="icon icon-saletag" id="icon-saletag">
                  <path d="M10 3a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm0-3H7a1 1 0 0 0-.71.29l-6 6a1 1 0 0 0 0 1.42l4 4a1 1 0 0 0 1.42 0c.19-.2 5.8-5.81 6-6A1 1 0 0 0 12 5V2a2 2 0 0 0-2-2z" fill="#a1a1a1"></path>
              </svg>
              <span>${item.discount_application.title}</span>
            </li>`;
        });
        $(el).find(".pro-disct-box").html(item_disct_str);

        if (card_items[i].final_price == card_items[i].original_price) {
          $(el).find(".price-box .discounted_price").hide();
          $(el).find(".price-box .original_price").addClass("last-show-price");
        } else {
          $(el).find(".price-box .discounted_price").show();
          $(el)
            .find(".price-box .original_price")
            .removeClass("last-show-price");
        }
      });
    },

    doUpdateDropdownCart: function (cart) {
      let dropdown_products_list = $("#dropdown-cart .mini-products-list");
      $("[data-cart-count]").text(cart.item_count);
      $(".wrapper-cartCount").show();
      ella.renderSidebarCartCalcPrice(cart, false);

      $.ajax({
        url: window.router + "/cart?view=ajax_side_cart",
        cache: false,
        complete: function () {
          ella.hideSideBarLoading();
        },
        success: function (data) {
          dropdown_products_list.html($(data));
          ella.initNumberInput(dropdownCart, ella.dropdownCartQuantityChange);
          ella.checkItemsInDropdownCart();
          ella.initRemoveItemDropdownCart();
    ...
    changeSwatchQs: function () {
      $(".selector-wrapper :radio").on("change", function (e) {
        ...
        var labelSave = productItem.find(".sale-label");
        var option_color = productItem
          .find(".option-color")
        ...
        var selectedSwatchOpt1 = productItemLayout
          .find(".selector-wrapper-1")
          .find("input:checked")
          .val();
        var selectedSwatchOpt2 = productItemLayout
          .find(".selector-wrapper-2")
          .find("input:checked")
          .val();
        var selectedSwatchOpt3 = productItemLayout
        ...
        switch (optionIdx) {
            ...
            var availableVariants = variantList.find(function (variant) {
              if (option_color == 1) {
                return (
                  ...
                  variant.option1 == selectedSwatchOpt2
                );
              } else {
                if (option_color == 2) {
                  return (
          ...
          case 1:
            var availableVariants = variantList.find(function (variant) {
              if (option_color == 1) {
                return (
                  variant.option2 == selectedSwatchOpt1 &&
                  variant.option1 == thisVal &&
                  variant.option3 == selectedSwatchOpt3
                );
              } else {
                if (option_color == 2) {
                  return (
                    variant.option3 == selectedSwatchOpt1 &&
                    variant.option1 == thisVal &&
                    variant.option2 == selectedSwatchOpt3
                  );
                } else {
                  return (
        ...
        if (selectedVariant.compare_at_price > selectedVariant.price) {
          ...
          productItem.removeClass("on-sale");
          labelSave.hide();
      ...
      $(
        ".product-card__variant--popup--content select.single-option-selector"
      ).on("change", function () {
        var _self = $(this);
        var productItem = $(this).parents(".product-item");
        var productItemLayout = $(this).parents(".action");
    ...
    checkStatusSwatchQs: function (productItem, productItemLayout) {
      if (window.use_color_swatch) {
        ...
        var get_json = productItem.data("json-product");
        var variantList = get_json.variants;
        var options = productItem.find(
          ".product-card__variant--popup--content [data-option]"
        );
        var option_color = productItem
          .find(".option-color")
          .data("option-position");
    ...
    initQuickshop: function () {
      ...
      body
        .off("click.quickshop")
        .on("click.quickshop", btnQuickshop, function (e) {
          e.preventDefault();
          e.stopPropagation();
          var _self = $(this),
      ...
      body
        ...
        .on("click.cancelquickshop", cancelQuickshop, function () {
    ...
    initColorSwatchGrid: function () {
      ...
      body
        ...
        .on("click.toggleClass", itemSwatchSlt, function () {
          ...
          productItemElm
            .find("a:not(.btn-cancel):not(.number-showmore)")
            .attr(
              "href",
              href.split("?variant=")[0] + "?variant=" + product_id
            );
            ...
            if (window.layout_style == "layout_style_surfup") {
              ...
              productItemElm.find(".product-title").hasClass("change-text")
                ? productItemElm
                    .find(".product-title")
                    .find("[data-change-title]")
                    .html('<span class="line"> - </span>' + title)
                : productItemElm
                    .find(".product-title")
                    .addClass("change-text")
                    .append(
                      '<span data-change-title><span class="line"> - </span></span>' +
                        title +
                        "</span>"
                    );
            }
          ...
          if (self.data("with-one-option") != undefined) {
            ...
            if ($(".template-collection").length) {
              if (
                $(this).parents(".product-collection").hasClass("products-list")
              ) {
                productItemElm
          ...
          if (
            ...
            for (var i = 0; i < length; i++) {
              productItemElm
                .find('picture[data-index="' + i + '"] > *')
                .attr("srcset", list_cur_media[i].src);
            }
          } else {
    ...
    showSideBarLoading: function () {
      $(".sidebar-loading-modal").show();
    },

    hideSideBarLoading: function () {
      $(".sidebar-loading-modal").hide();
    },
      ...
      body
        ...
        .on(
          ...
          function (e) {
            ...
            let slideshow = $(this).closest(".home-slideshow");
            let autoplaySpeed = slideshow.find('[data-init-slideshow]').data('autoplay-speed')
            console.log(3828,slideshow,autoplaySpeed)
            let autoPlay = window.autoPlaySlideShowHalo;
            autoPlay.clearTimer(slideshow);

            // autoPlay.stopAutoSlide()
            // autoPlay.startAutoSlide($(".slide-action"), 10000000);
            // console.log(3845,window.autoPlaySlideShowHalo)
            // console.log(3827,slideshow)
            doc
              ...
              .on(
                ...
                function () {
                  autoPlay.setTimer(slideshow, autoplaySpeed);
    ...
    initMainPageProOption: function () {
      $(".index-normal-product-card .add-to-cart").click(function (e) {
        e.stopPropagation();
        e.preventDefault();
        ...
        var title = productItem.find(".pro-title").html();
        var image = productItem.find(".img-box img").attr("src");
        var size = productItem.find(".pro-size").find("span").html();
        var weight = productItem.find(".pro-weight").find("span").html();
        ella.doAjaxAddToCartNormal(params, true, title, image, size, weight);
      });
    },
    ...
    initProductReview: function () {
      var cookie = setInterval(function () {
        if (
          !$(".spr-reviews").hasClass("slick-initialized") &&
          $(".product-template-skin-1").length
        ) {
          ...
          self.find(".spr-review").each(function () {
            $(this)
              ...
              .appendTo($(this).find(".spr-review-footer"));
            self.find(".spr-pagination").remove();
          });
        } else {
          if (
            $(".product-template-surfup").length &&
            $(".spr-review-header .spr-review-footer").length == 0
          ) {
            var self = $(".spr-reviews");
            // console.log($('.spr-review-header .spr-review-footer').length);
            self.find(".spr-review").each(function () {
              $(this)
                .find(".spr-review-footer")
                .appendTo($(this).find(".spr-review-header"));
            });
          }
        }
      }, 1000);
      ...
      if ($("[data-load-video]").length) {
        $("[data-load-video]").on("click", function (e) {
          ...
          if ($(this).next(".fluid-width-video-wrapper").find("video").length) {
            $(this)
              .next(".fluid-width-video-wrapper")
              .find("video")
              .get(0)
              .play();
          } else {
        ...
        // if (window.innerWidth > 1200) {
        $(".custom-block-banner .fluid-width-video-wrapper").on(
          "click",
          function (e) {
          ...
          $(this).html(
            event.strftime(
              "" +
                ...
                "</span></div>" +
                '<div class="clock-item"><span class="num">%H</span><span>' +
                window.inventory_text.hours +
                "</span></div>" +
                '<div class="clock-item"><span class="num">%M</span><span>' +
                window.inventory_text.mins +
                "</span></div>" +
                '<div class="clock-item"><span class="num">%S</span><span>' +
    ...
    linkClickToggleSubMenuMobile: function (mainMenu) {
      ...
      if (iconDropdown.length) {
        body
          .off("click.current")
          .on("click.current", ".site-nav .dropdown", function (e) {
            e.stopPropagation();
    ...
    ajaxFilterTags: function () {
      body
        ...
        .on(
          "click.filterTags",
          ".sidebar-tags .list-tags a, .refined .selected-tag",
          function (e) {
            e.preventDefault();
            e.stopPropagation();
    ...
    initToggleWidgetTitleSidebarFilter: function () {
      ...
      var wrapper = $(".toolbar");
      var else_wrapper = $(".countdown-box");
      ...
      if (win.innerWidth() < 1200) {
        ...
        if (win.innerWidth() < 992) {
          $(".filters-toolbar__sortby").insertAfter(
        ...
        if ($(".collection-template-skin-1").length) {
          ...
          body
            ...
            .on("click.toggleSidebar", sidebarLabelDesktop, function () {
              $(this)
        ...
        if (
          $(".toolbar").length &&
          !$(".toolbar").hasClass("different-toolbar")
        ) {
      ...
      body
        ...
        .on("click.viewMoreFilter", viewMore, function () {
          ...
          switch (col) {
            ...
            case 4:
              ...
              gridItem
                ...
                .addClass("col-6 col-md-4 col-lg-3 col4");
              break;
      ...
      $("[data-template-cart-edit] .swatch :radio").on("change", function (e) {
        ...
        if (selectedVariant.featured_image) {
          productItem
            ...
            .attr("src", selectedVariant.featured_image.src);
        }
        var value = $(this).val();
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            productItem
              .find('[name="quantity"]')
              .attr("data-line", arr[0].value);
          },
        });
        $(".error-message-input").text("");
      });

      $("[data-template-cart-edit] .single-option-selector").on(
        "change",
        function () {
          var _self = $(this);
          var productItem = $(this).parents(".product-edit");
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              setTimeout(function () {
                ...
                let edit_card_list = $(".product-edit");
                ella.initNumberInput(edit_card_list);
              }, 500);
    ...
    addMoreCart: function () {
        ...
        .on("click", function (e) {
          ...
          $(first)
            ...
            .each(function () {
              ...
              $(this)
                .find('[name="option-0"]')
                .attr("name", "list-" + length + "-option-0")
                .attr("id", "list-" + length + "-" + option_1);
              $(this)
                .find('[name="option-1"]')
                .attr("name", "list-" + length + "-option-1")
                .attr("id", "list-" + length + "-" + option_2);
              $(this)
                .find('[name="option-2"]')
                .attr("name", "list-" + length + "-option-2")
                .attr("id", "list-" + length + "-" + option_3);

              $(this)
                .find('[data-label="swatch-edit-cart-0"]')
                .attr("for", "list-" + length + "-" + option_1);
              $(this)
                .find('[data-label="swatch-edit-cart-1"]')
                .attr("for", "list-" + length + "-" + option_2);
              $(this)
                .find('[data-label="swatch-edit-cart-2"]')
                .attr("for", "list-" + length + "-" + option_3);
            });
      ...
      body
        .off("click.removeItemCart", removeItem)
        .on("click.removeItemCart", removeItem, function (e) {
          ...
          if (self.attr("disabled") !== "disabled") {
            ...
            groupedProduct.not(".first").each(function () {
              var variantId = $(this).find('[name="id"]').val(),
                ...
                line = parseInt(
                  $(this).find('input[name="quantity"]').data("line")
                );
    ...
    cartPageQuantityChange(input) {
      clearTimeout(ella.inputChangeTimeOut);
      ella.inputChangeTimeOut = setTimeout(function () {
        var self = input;
        var productItem = self.parents(".cart-product-item"),
          line = self.data("line"),
          val = self.val(),
          productId = $(productItem).data("item-id");
        productItem.find('input[name="updates[]"]').val(val);
        if (line < val) {
          ...
          self.val(line);
          $(".ajax-error-message").text(
            "You can't add more, there are " + line + " left in the product"
          );
          ella.showModal(".ajax-error-modal");
          ella.doAjaxUpdateCart(productId, line, productItem);
        } else {
          productItem.find(".error-message-input").text("");
          self.css("border-color", "unset");
          ella.doAjaxUpdateCart(productId, val, productItem);
        }
      }, 800);
    },
    changeQuantityAddToCart: function () {
      let cartList = $(".cart-list");
      ella.initNumberInput(cartList, ella.cartPageQuantityChange);
      ...
      $(".cart-form .remove ").on("click", function (event) {
        ...
        Shopify.removeItem(productId, function (cart) {
          ella.initFreeShippingMessage();
          $(productItem).remove();
          ella.updateDropdownCartOnMainCartPage(cart);
        });
      });
    },
    ...
    FreeShippingMessage: function (cart) {
      ...
      var progress =
        '<div class="progress_shipping" role="progressbar" aria-label="progressbar" style="height: 15px; margin-top: 10px; margin-bottom: 10px;background-color: #e1dfd6;-webkit-box-shadow: inset 0 1px 2px rgba(0,0,0,.1);box-shadow: inset 0 1px 2px rgba(0,0,0,.1);">\
            <div class="progress-meter" style="position: relative;display: block;height: 100%;background-color: ' +
        color +
    ...
    // 更新购物车主页购物车内容
    doAjaxUpdateCart: function (productId, quantity, productItem) {
      $.ajax({
        type: "post",
        url: "/cart/change.js",
          ...
          if (self.attr("disabled") !== "disabled") {
            ...
            switch (window.ajax_cart) {
              ...
              case "normal":
                ...
                var image =
                  productItem.find(".product-grid-image img").data("srcset") ||
                  productItem.find(".product-image img").data("src");
                // var size = productItem.find(".pro-size")
                // var weight = productItem.find(".pro-weight")
                if (!image) {
                  image =
                    productItem
                ...
                ella.doAjaxAddToCartNormal(data, true, title, image);
    ...
    closeSuccessModal: function () {
      ...
      closeWindow.click(function (e) {
        ...
        if (
          $("[data-more-view-product-qv] .product-img-box .slider-for")
            .find(".slick-current")
            .find("iframe").length
        ) {
          var player = $(".slider-for")
            .find(".slick-current")
            .find("iframe")
            .get(0);
          postMessageToPlayer(player, {
      ...
      editCart.on("click", function (e) {
        if (
          !modalContentEdit.is(e.target) &&
          !modalContentEdit.has(e.target).length
        ) {
          editCart.fadeOut(500, function () {
            html.removeClass("halo-modal-open");
            html.css({
    ...
    doAjaxAddToCartNormal: function (
      data,
      showPopModal,
      title,
      image,
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          if (showPopModal) {
            ...
            modalContent.find(".ajax-product-image").attr("src", "");
            modalContent.find(".ajax-product-image").attr("src", image);
            modalContent.find(".message-added-cart").show();
            modalContent.find(".pro-info-box").show();
            modalContent.find(".actions").show();
            modalContent
              .find(".pro-info")
              .html('<div class="pro-title"></div>');
            modalContent.find(".pro-title").html(ella.translateText(title));
            if (!!size) {
              modalContent
                .find(".pro-info")
                .append(
                  '<div class="pro-param pro-size"><span>' +
                    ella.translateText(size) +
                    "</span></div>"
                );
            }
            if (!!weight) {
              modalContent
                .find(".pro-info")
                .append(
                  '<div class="pro-param pro-weight"><span>' +
                    ella.translateText(weight) +
                    "</span></div>"
                );
            }
    ...
    getPopupShoppingCart: function (shouldShowModel, handle) {
      var ajaxCartModal = $("[data-ajax-cart-success]"),
        modalContent = ajaxCartModal.find(".cart-popup-content"), // 在setting中给ajax_popup_cart设置upsell才会有这个标签，后续排查该使用
        ...
        if (handle != undefined) {
          ...
          if (shouldShowModel) {
            ...
            $(document).ajaxComplete(function (event, xhr, settings) {
              if (
                settings.url === "/collections/all?view=related" ||
                settings.url === "" + handle + ""
              ) {
                try {
                  if (ella.checkNeedToConvertCurrency()) {
    ...
    productPageInitProductTabs: function () {
      ...
      if (
        $(".product-template-skin-1").length ||
        $(".product-template-supermarket").length
      ) {
    ...
    initStickyForProductFullWidth: function () {
      var productTplFullWidth = $(".product-template-full-width"),
        ...
        initSticky = function () {
          if (
            stickyElm1.outerHeight() < stickyElm2.outerHeight() ||
            stickyElm1.outerHeight() < stickyElm3.outerHeight()
          ) {
    ...
    openSearchForm: function () {
      ...
      doc
        ...
        .on("click.toggleSearch", iconSearchSlt, function (e) {
          ...
          $(".header-search").find(".quickSearchResultsWrap").show();

          html.addClass("search-open");
          html.removeClass("search-dropdown-open");
          $(body).addClass("sidebar-show");
          $(".search-form .header-search").show();
          var self = $(this);
          ...
          if (
            !self
              ...
              .find(
                ".quickSearchResultsWrap .header-search__product .products-grid .product-item"
              ).length
          ) {
            $.ajax({
              type: "get",
      ...
      // doc.off("click.offPopup").on("click.offPopup", function (e) {
      ...
      //   var customerSidebar = $("#dropdown-customer");
      //   var cartSidebar = $("#dropdown-cart");
      //   var mainMenu = $(".wrapper-navigation .jas-mb-style");
      //   var menuCloseBtn = $(".wrapper-navigation .close-menu-mb");
      //   if (
      //     !searchForm.is(e.target) &&
      //     !iconSearchSlt.is(e.target) &&
      //     !slideshow.has(e.target).length &&
      //     !searchForm.has(e.target).length &&
      //     !searchProduct.has(e.target).length &&
      //     !searchTrending.has(e.target).length &&
      //     !overlay.has(e.target).length &&
      //     !searchBottom.is(e.target) &&
      //     !searchSidebar.is(e.target) &&
      //     !searchSidebar.has(e.target).length &&

      //     !customerSidebar.is(e.target) &&
      //     !customerSidebar.has(e.target).length &&
      //     !cartSidebar.is(e.target) &&
      //     !cartSidebar.has(e.target).length &&
      //     !mainMenu.is(e.target) &&
      //     !mainMenu.has(e.target).length &&
      //     !menuCloseBtn.is(e.target) &&
      //     !menuCloseBtn.has(e.target).length
      //   ) {
      //     $(".search-form .header-search").hide();
      //     html.removeClass("search-open");
      //     $(".close-search-style-3").hide();
      //     html.removeClass("search-dropdown-open");
      ...
      //   }
      // });
      // background-sidebar-cover

      $(
        ".header_mobile_3 .header-mb-right .search-form .search-bar .header-search__input"
      )
        .off("click.hideCloseSearch")
        .on("click.hideCloseSearch", function (e) {
          $(".close-search-style-3").show();
        });

      $(".close-search-style-3, [data-search-close-sidebar]")
        .off("click.hideQuickSearchStyle3")
        .on("click.hideQuickSearchStyle3", function (e) {
          e.preventDefault();
          e.stopPropagation();
          $(".search-form .header-search").hide();
          $(".quickSearchResultsWrap").hide();
    ...
    stickyFixedTopMenu: function () {
      if (window.fixtop_menu) {
        ...
        let lastScrollTop = 0;
        // 菜单元素
        const $stickyPc = $("[data-sticky-pc]");
        const $stickyMb = $("[data-sticky-mb]");
        ...
        const initSticky = () => {
          if (window.innerWidth >= 1200) {
            setTimeout(() => {
              ...
              $stickyPc.unstick();
              $header.css("height", "");
              $stickyPc.sticky({ zIndex: 99 });
              
              $stickyPc.on("sticky-start", () => {
                body.addClass("has_sticky");
              });
              
              $stickyPc.on("sticky-end", () => {
                body.removeClass("has_sticky");
              });
            }, 100);
          } else {
        ...
        const handleScroll = () => {
          ...
          const currentSticky = window.innerWidth >= 1200 ? $stickyPc : $stickyMb;
          
          // 只在菜单处于粘性状态时应用滚动行为
          if (currentSticky.parent('#sticky-wrapper').hasClass('is-sticky')) {
            // 下滑且滚动距离超过100px时收起菜单
            if (scrollTop > lastScrollTop && scrollTop > 100) {
              currentSticky.addClass('sticky-hidden');
            } 
            // 上滑时展开菜单
            else {
              currentSticky.removeClass('sticky-hidden');
            }
          }
        ...
        // 监听滚动事件
        $(window).off('scroll.stickyMenu').on('scroll.stickyMenu', handleScroll);
        
        // 窗口大小改变时重新初始化
        $(window).off('resize.stickyMenu').on('resize.stickyMenu', () => {
          initSticky();
        });
      }
    },
      ...
      if (blockSticky.length) {
        ...
        var activeVariantSelected = function () {
          ...
          $(".selector-wrapper").change(function () {
            ...
            ella.changeLevelDisct(n);
          });
        };

        if ($("#product-add-to-cart").val() == "Sold Out") {
          $(".level-discount-box").hide();
        } else {
          $(".level-discount-box").show();
        }
        ...
        $(window).scroll(function () {
          ...
          if (scrollTop + $(this).height() + 100 >= $(document).height()) {
        ...
        var initGraThisDeal = function () {
          $(".bulk-add-btn").click(function (e) {
            e.preventDefault();
            let choice_num = $(".disct-radio-box")
              .find("input:checked")
              .prev()
              .data("buy_num");
            var variantId = $(".level-discount-box")
              .find("input[name=pro_id]")
              .val();
            var image = $(".pr-img.sticky-item").find("img").attr("src");
            let title = $(".pr-img.sticky-item")
            ...
            ella.doAjaxAddToCartNormal(params, true, title, image);
          });
        };
    ...
    setAddedForCompareIcon: function (ProductHandle) {
      var compareElm = $(
          '[data-compare-product-handle="' + ProductHandle + '"]'
        ),
      ...
      if ($(".l")) compareCountNum.text(totalProduct);
    ...
    doAddOrRemoveCompare: function () {
      ...
      doc
        .off("click.doAddOrRemoveCompare", iconCompare)
        .on("click.doAddOrRemoveCompare", iconCompare, function (e) {
          e.preventDefault();
    ...
    initCompareSelected: function () {
      ...
      doc
        .off("click.compareSelected", iconCompareSelected)
        .on("click.compareSelected", iconCompareSelected, function (e) {
          e.preventDefault();
          e.stopPropagation();
    ...
    createCompareItem: function (ProductHandle) {
      var compareProduct = $("[data-compare-modal]").find(
          ".halo-modal-body .compare-content .product-grid"
        ),
        compareRating = $("[data-compare-modal]").find(
          ".halo-modal-body .compare-content .rating"
        ),
        compareDescription = $("[data-compare-modal]").find(
          ".halo-modal-body .compare-content .description"
        ),
        compareCollection = $("[data-compare-modal]").find(
          ".halo-modal-body .compare-content .collection"
        ),
        compareAvailability = $("[data-compare-modal]").find(
          ".halo-modal-body .compare-content .availability"
        ),
        compareProductType = $("[data-compare-modal]").find(
          ".halo-modal-body .compare-content .product-type"
        ),
        compareSKU = $("[data-compare-modal]").find(
      ...
      compareOption4 = $("[data-compare-modal]").find(".option4");
      compareOption5 = $("[data-compare-modal]").find(".option5");
      ...
      jQuery.getJSON("/products/" + ProductHandle + ".js", function (product) {
        ...
        //   productIDCompare +
        //   '"></span>';
        var rating = `<div class="stars-box">
                  <div
                    class="loox-rating no-rating-label"
                    data-fetch
                    data-id="${productIDCompare}"
                    data-pattern=""
                  ></div>
                </div>`;
        // Description
        ...
        if (product.compare_at_price > product.price) {
          ...
          productHTML +=
            ...
            Shopify.formatMoney(product.price, window.money_format) +
            "</span>";
          productHTML += "</span>";
        } else {
          productHTML +=
      ...
      $.ajax({
        url: "/products/" + ProductHandle + "?view=get_product_metafield_ajax",
        success: function (data) {
          let dimension_str = $(data).find(".dimension-info");
          let load_capacity_str = $(data).find(".load_capacity-info");
          compareOption4.append(dimension_str);
          compareOption5.append(load_capacity_str);
        },
      });
    },
    ...
    initBundleProducts: function () {
      Shopify.addItem = function (e, i, a, o) {
        let n = {
          quantity: i,
          id: e,
        };
        !1 != a && (n.properties = a),
          $.ajax({
            ...
            error: function (a) {
              console.log("AJAX Error:", a),
                console.log("Error details:", $.responseJSON),
                $.responseJSON &&
                  $.responseJSON.description &&
                  Shopify.failedDescriptions.push($.responseJSON.description),
                Shopify.failedIds.push(e),
                Shopify.successCount++,
                "function" == typeof o && o();
            },
          });
      };
      ...
      var handleCheckedProduct = function () {
        ...
        body
          ...
          .on("click.checkedProduct", bundleCheckbox, function (e) {
            ...
            if (!ipt.prop("checked") && !ipt.prop("disabled")) {
      ...
      var updateTotalPrice = function () {
        ...
        bundleProItem.each(function () {
          ...
          } else if (inputElm.length) {
            var price = $(this).find("input[name=group_id]").data("price");
          } else {
            var price = $(this).find("input[name=id]").data("price");
          }
          let rate =
            $(this).find(".sale-with-group").data("group-discount-rate") || 0;
          let bundleProPrice = Math.ceil((price * (100 - rate)) / 100);
          if (price) {
            totalPrice += price;
            gropu_total_price += bundleProPrice;
          }
        });
        if (bundlePrice.length > 0 && oldPrice.length > 0) {
          oldPrice.html(Shopify.formatMoney(totalPrice, window.money_format));
          bundlePrice.html(
            Shopify.formatMoney(gropu_total_price, window.money_format)
          );
          if (checkedProductLength == maxProduct) {
            window.bundleMatch = true;
            bundlePrice.show();
            oldPrice.show();
            $(".products-grouped-action .total-price").hide();
          } else {
            window.bundleMatch = false;
            bundlePrice.hide();
            oldPrice.hide();
            $(".products-grouped-action .total-price").show();
          }
        }
        if (totalPrice == 0) {
          $("[data-bundle-addtocart]").attr("disabled", true);
        } else {
          $("[data-bundle-addtocart]").attr("disabled", false);
        }
        $(".products-grouped-action .total .total-price").html(
      ...
      var changeSwatchProductBundle = function () {
        $(".fbt-products-list .product-title").each(function (index, ele) {
          var productId = $(ele)
            .parents(".fbt-product-item")
            .data("bundle-product-id");
          var variantList = window.productVariants[productId];
          $(ele).text(variantList[0].name);
        });
        ...
        doc
          ...
          .on("change.changeBundleSwatch", swatchSlt, function (e) {
            ...
            if (self.prop("checked")) {
              ...
              var selectedVariant;
              var swatchBundleProduct = $(
                '[data-bundle-product-id="' + productId + '"]'
              );
              var fbtPrice = swatchBundleProduct.find(".fbt-prices"),
                priceSale = fbtPrice.find(".price-sale"),
                productPrice = fbtPrice.find("[data-fbt-price-change]");
              var productInput = swatchBundleProduct.find("[name=group_id]");
              var bundleProductTitle =
                swatchBundleProduct.find(".product-title");
              ...
              bundleProductTitle.text(selectedVariant.name);
              var group_sale_price = swatchBundleProduct
                .find(".sale-with-group")
                .find("[sale-with-group-price]");

              var group_sale_off_rate = swatchBundleProduct
                .find(".sale-with-group")
                .attr("data-group-discount-rate");

              let group_price = Math.ceil(
                (selectedVariant.price * (100 - group_sale_off_rate)) / 100
              );

              group_sale_price.html(
                Shopify.formatMoney(group_price, window.money_format)
              );
              ...
              $(this)
                ...
                .each(function () {
                  ...
                  $(this)
                    ...
                    .text($(this).find("input:checked").val());
                });
            }
          });
      };

      var addSuccessPop = function () {
        var ajaxCartModal = $("[data-ajax-cart-success]"),
          modalContent = ajaxCartModal.find(".cart-modal-content");
        modalContent.find(".message-added-cart").show();
        modalContent.find(".pro-info-box").hide();
        modalContent.find(".actions").hide();
        ajaxCartModal.fadeIn(600, function () {
          // html.addClass('halo-modal-open');
          if ($("[data-quickview-modal]").is(":visible")) {
            $("[data-quickview-modal]").hide();
        ...
        doc
          ...
          .on("click.bundleAddToCart", btnAddToCartSlt, function (e) {
            ...
            var self = $(this),
              ...
              // ),
              bundleProduct = form.find(".fbt-product-item.isChecked"),
            ...
            Shopify.moveAlong = function () {
              if (Shopify.queue.length) {
                ...
                // productInput.val(selectedVariant.id);
                $(".fbt-products-list")
                  .find(".fbt-product-item")
                  .each((index, el) => {
                    let productId = $(el).data("bundle-product-id");
                    var productInput = $(
                      '[data-bundle-product-id="' + productId + '"]'
                    ).find("[name=group_id]");
                    console.log(22222222, productInput);
      ...
      bundleSlider();
      if (
        $(".layout_style_1170 ").length ||
        $(".layout_style_fullwidth.product_layout_skin_1").length ||
        $(".layout_style_flower.product_layout_skin_1").length ||
        $(".layout_style_suppermarket.product_layout_supermarket").length ||
        $(".product_layout_supermarket").length ||
        $(".product-template-surfup").length
      ) {
    ...
    hide_filter: function () {
      ...
      $(".close--list_tags").click(function (e) {
        $(this).closest(".list-tags").removeClass("full");
      });
    },
    ...
    appendProductRecomendation: function () {
      if (!$(".product-template-surfup").length) {
        var ProductRecomendation = $("#product-recommendations"),
          appenRecomendation = $(
            ".template-product .product .product_bottom .related-products"
          );
        appenRecomendation1 = $(
          ".template-product .product .product_bottom .relate-verticle .related-products"
        );
        appenRecomendation2 = $(
          ".template-product .product .relate-verticle"
        ).find("[data-sticky-3] .related-products");
                ...
                if (chk == false) {
                  ...
                  $.ajax({
                    ...
                    success: function (data) {
                      ...
                      if (
                        $(
                          ".wrapper_header_supermarket:not(.disable_vertical_menu)"
                        ).length &&
                        $(".vertical-menu").length
                      ) {
    ...
    beforeYouLeave: function () {
      var $beforeYouLeave = "#before-you-leave",
        ...
        $beforeYouLeave_close2 = $($beforeYouLeave).find(
          ".before-you-leave__bg #reload_page"
        ),
    ...
    _videoPopup: function () {
      ...
      $(".video-open-popup a")
        ...
        .on("click", function () {
          ...
          const $content =
            '<div class="fluid-width-video-wrapper"><iframe\
                                        id="player"\
                                        type="text/html"\
                                        width="100%"\
                                        frameborder="0"\
      ...
      $("[data-popup-video], [data-popup-video] .close-modal").on(
        "click",
        function (e) {
    ...
    _multiHomepage: function () {
      ...
      if (document.URL != canonical) {
        $("[data-load-page=" + $.cookie("page-url") + "]")
          .addClass("active")
          .siblings()
          .removeClass("active");
      }
    ...
    checkbox_submit: function () {
      ...
      $(".footer-newsletter .input-group-field").keypress(function (e) {
        if (e.keyCode == 13 && check == false) e.preventDefault();
      });
    },
    ...
    _showmore_html: function () {
      ...
      if (height > 70) {
        var btn =
          ...
          window.inventory_text.show_more +
          "</span></a>";
        wrapper.append(btn);
    ...
    hideSizechart: function () {
      setTimeout(function () {
        var size_chart_image = $(
          "#size_chart .size-chart-img .size-chart-img-display"
        );
    ...
    initCustomInfo: function () {
      doc.on("click", "[data-custom-information]", (event) => {
        ...
        var $target = $(event.currentTarget),
          $popupContent = $(
            "#halo-global-custom-information-popup .halo-popup-content"
          ),
          $popupTitle = $(
            "#halo-global-custom-information-popup .halo-popup-title"
          ),
        ...
        if (body.hasClass("custom-info-show")) {
          if (
            ...
            $(event.target).closest(
              "#halo-global-custom-information-popup .modal-content"
            ).length === 0
          ) {
            body.removeClass("custom-info-show");
          }
    ...
    // hcx-------------------------------start
    // 初始化遮罩层的鼠标展示
    initMouseOverCover: function () {
      $(".background-sidebar-cover").mouseover(function () {
        $(this)
          .children(".close-icon-on-cover")
          .addClass("close-icon-on-cover-show");
      });
      $(".background-sidebar-cover").mouseout(function () {
        $(this)
          .children(".close-icon-on-cover")
          .removeClass("close-icon-on-cover-show");
      });
      $(".background-sidebar-cover").mousemove(function (evt) {
        $(this).children(".close-icon-on-cover").offset({
          //offset基于文档流左上角，要用pageX，pageY
          left: evt.pageX,
          top: evt.pageY,
        });
      });
      $(".background-sidebar-cover").click(function () {
        ella.closePopOnCover();
      });
    },
    closePopOnCover: function () {
      html.removeClass("search-open");
      html.removeClass("search-dropdown-open");
    ...
    initMainPageSlider: function () {
      if($("[copy-discount-code]").length <= 0) return;
      // 使用插件复制文本
      var clipboard = new ClipboardJS("[copy-discount-code]");
      let canClick = true;
      target = null;
      $(".slideshow [copy-discount-code]").append(
        '<span class="copy-discount-code-cover">COPY</span>'
      );
      $(".collection-image-box [copy-discount-code]").append(
        '<span class="copy-discount-code-cover">COPY</span>'
      );

      clipboard.on("success", function (e) {
        let discountList = $(".discount-list");
        if (canClick || target !== e.trigger) {
          target = e.trigger;
          $(target).find(".copy-discount-code-cover").text("COPIED");
          ...
          e.clearSelection();
          // $(".ajax-warnning-message").html('This promotion discount has not yet started. Please wait patiently! :)');
          // ella.showModal(".ajax-warnning-modal");
          setTimeout(() => {
            canClick = true;
            e.trigger.disabled = false;
            $(e.trigger).find(".copy-discount-code-cover").text("COPY");
            if (discountList.length > 0) {
              $(e.trigger).text("COPY");
            }
            $(e.trigger).removeClass("disabled");
          }, 3000);
        }
      });
    },
    ...
    initActiveCountdown() {
      this.my_countdown();
      const wrapper = $(".countdown-box");
      if (wrapper.length === 0) return;

      const h_wrapper = wrapper.outerHeight() + 30;
      const top = wrapper.offset().top;
      const collectionSection = $('[data-section-type="collection-template"]');
      ...
      $(window).scroll(function () {
        ...
        const h1 = $(".sticky-wrapper.is-sticky").outerHeight() || 0;
        ...
        if (isScrollingDown) {
          ...
          if (scrollTop > top + 300) {
            collectionSection.css("padding-top", h_wrapper);
            wrapper.addClass("countdown-fix");
          } else {
            collectionSection.css("padding-top", 0);
            wrapper.removeClass("countdown-fix");
          }
        } else {
          // 向上滚动时：按原有逻辑基于 sticky 元素高度定位
          if (scrollTop > top + 300) {
            collectionSection.css("padding-top", h_wrapper);
            wrapper.addClass("countdown-fix");
            wrapper.css("top", h1); // 向上滚动时使用 h1 作为 top 值
          } else {
            collectionSection.css("padding-top", 0);
            wrapper.removeClass("countdown-fix");
            wrapper.css("top", 0);
    ...
    my_countdown() {
      const end_time = new Date("2035/12/5 3:00:00");
      const split_day = 7; // 间隔时间
      let time_str =
        "This activity has ended, looking forward to your next participation :)";
      let falseSaleCountDown = $("#active-count-down");
      let progressBarBox = $(".progress-bar-box");
      let now_time = new Date();
      let alltime = end_time.getTime() - now_time.getTime();
      if (progressBarBox.length > 0) {
        let split_timestamp = split_day * 1000 * 60 * 60 * 24; // 活动总时间
        let time_left = alltime % split_timestamp; // 活动剩余时间
        let time_already = split_timestamp - time_left; // 活动已进行时间
        let progress =
          Math.round((time_already / split_timestamp) * 10000) / 100;
      ...
      if (falseSaleCountDown.length > 0) {
        setInterval(function () {
          now_time = new Date();
          alltime = end_time.getTime() - now_time.getTime(); //总的时间（毫秒）
          if (alltime > 0) {
            var scend = parseInt((alltime / 1000) % 60); //秒
            var scend_str =
              scend == 0 ? "00" : scend < 10 ? "0" + scend : String(scend);
            var minute = parseInt((alltime / 1000 / 60) % 60); //  分钟
            var minute_str =
              minute == 0 ? "00" : minute < 10 ? "0" + minute : String(minute);
            var hour = parseInt((alltime / 1000 / 60 / 60) % 24); //小时
            var hour_str =
              hour == 0 ? "00" : hour < 10 ? "0" + hour : String(hour);
            var day = parseInt((alltime / 1000 / 60 / 60 / 24) % split_day); //天数（每三天自动更新）
            var day_str = day == 0 ? "00" : day < 10 ? "0" + day : String(day);
            if (day > 0) {
              time_str = `
                <div>
                  <div class="time-item">${day_str}<span class="small-unit">D</span></div>
                  <div class="unit">days</div>
                </div>
                <span>:</span>
                <div>
                  <div class="time-item">${hour_str}<span class="small-unit">H</span></div>
                  <div class="unit">hours</div>
                </div>
                <span>:</span>
                <div>
                  <div class="time-item">${minute_str}<span class="small-unit">M</span></div>
                  <div class="unit">min</div>
                </div>
                <span>:</span>
                <div>
                  <div class="time-item">${scend_str}<span class="small-unit">S</span></div>
                  <div class="unit">sec</div>
                </div>
              `;
              // time_str = day + "Day " + hour + "H:" + minute + "M:" + scend + "S";
            } else {
              time_str = `
                <div>
                  <div class="time-item">${hour_str}<span class="small-unit">H</span></div>
              ...
              // time_str = hour + "H:" + minute + "M:" + scend + "S";
            }
          } else {
            $(".wrapper-newsletter").find(".des").hide();
          }
          falseSaleCountDown.html(time_str);
        }, 1000);
      }
    },
    initSearchRecord() {
      this.setSearchRecord();
      ella.initClearSearchRecord();
    },
    setSearchRecord() {
      let temp_search_list = localStorage.getItem("search_keywords");
      let search_list = !!temp_search_list ? JSON.parse(temp_search_list) : [];
      if (!!search_list && search_list.length > 0) {
        $(".header-search__trending").hide();
        $(".header-search__record").show();
        let str = "";
        search_list.forEach((item) => {
          str += `<li class="item">
            <a href="/search?type=product&q=${item}" class="highlight">
              <span>${item}</span>
            </a>
        ...
        $(".quickSearchResultsWrap")
          .find(".header-search__record")
          .find(".list-item")
          .html(str);
      } else {
        $(".header-search__trending").show();
        $(".header-search__record").hide();
      }
      // 重新绑定事件
      this.initDeleteSearchRecord();
    },
    initDeleteSearchRecord() {
      $(".header-search__record .delete-record")
        .off("click")
        .on("click", function (e) {
          let deleteOne = $(this).siblings().find("span").text();
          let search_list = JSON.parse(localStorage.getItem("search_keywords"));
          let filteredArray = search_list.filter((item) => item !== deleteOne);
          localStorage.setItem(
            "search_keywords",
            JSON.stringify(filteredArray)
          );
          ella.setSearchRecord();
        });
    },
    initClearSearchRecord() {
      $(".header-search__record .clear-record").click(function () {
        localStorage.setItem("search_keywords", []);
        ella.setSearchRecord();
      });
    },
    initCustomLoading() {
      setTimeout(function () {
        ...
        $(".loading-bar").fadeOut("slow", () => {
          $(".loading-bar").hide(); // 用于fadeOut未在内联标签上增加style="display:none"的情况
          $(".loading-finish").fadeIn("slow");
        });
      }, 1200);
    },
    // 初始化降价通知的插件展示
    initPlugIn() {
      ...
      var observer = new MutationObserver(function (mutationsList, observer) {
        // 使用mutionsList中的信息进行相应的操作
        for (var mutation of mutationsList) {
          if (mutation.type === "childList") {
            mutation.addedNodes.forEach(function (node) {
              if ($(node).hasClass("gw-float-widget")) {
                let showedPlugInFT = sessionStorage.getItem("showedPlugInFT");
                if (!showedPlugInFT) {
                  // 添加样式
                  $(".gw-float-widget[gw-price-drop]").addClass(
                    "plugin-scroll-out"
                  );
                  sessionStorage.setItem("showedPlugInFT", true);
                  observer.disconnect();
                }
              }
            });
    ...
    // 切换变体时，刷新阶梯折扣数据
    changeLevelDisct(variant_id) {
      if ($("#product-add-to-cart").val() == "Sold Out") {
        $(".level-discount-box").hide();
      } else {
        $(".level-discount-box").show();
      }
      $(".level-discount-box").find("input[name=id]").val(variant_id);
      let temp_now_price = $(".product-shop").find(".price").eq(0).text();
      let now_price = Number(temp_now_price.replace("$", "").replace(/,/g, "")) * 100;

      $(".level-disct-item").each((index, item) => {
        let off_rate = $(item).find("[data-record]").data("off_rate");
        let buy_num = $(item).find("[data-record]").data("buy_num");

        let normal_price = Math.ceil(now_price);
        let disct_price = Math.ceil((now_price * (100 - off_rate)) / 100);
        let total_normal_price = normal_price * buy_num;
        let total_disct_price = disct_price * buy_num;

        let normal_price_str = Shopify.formatMoney(
          normal_price,
          window.money_format
        );
        let disct_price_str = Shopify.formatMoney(
          disct_price,
          window.money_format
        );
        let total_normal_price_str = Shopify.formatMoney(
          total_normal_price,
          window.money_format
        );
        let total_disct_price_str = Shopify.formatMoney(
          total_disct_price,
          window.money_format
        );

        $(item).find(".normal-price").text(normal_price_str);
        $(item).find(".disct-price").text(disct_price_str);
        $(item).find(".total-normal-price").text(total_normal_price_str);
        $(item).find(".total-disct-price").text(total_disct_price_str);
      });
    },
    // 获取url参数
    getQueryParam(param) {
    ...
    // 应用折扣码
    applyDiscountCode(discount_code, apply_btn) {
      let isSidebarDiscount =
        $(apply_btn).closest("#dropdown-cart").length > 0 ? true : false;
      $.ajax({
        url: "/discount/" + discount_code + "?redirect=/cart",
        beforeSend: function () {
          if (isSidebarDiscount) {
            ella.showSideBarLoading();
          } else {
            ella.showLoading();
          }
        ...
        success: function (res) {
          Shopify.getCart(function (cart) {
            if (isSidebarDiscount) {
              ella.hideSideBarLoading();
              ella.renderSidebarCartCalcPrice(cart, true, discount_code);
            } else {
              ella.hideLoading();
              ella.updateDropdownCartOnMainCartPage(cart, true, discount_code);
            }
          });
        },
      });
    ...
    // 价格计算，渲染购物车侧边栏的下半部分
    renderSidebarCartCalcPrice(cart, isFromDiscountApply, params) {
      // 折扣码相关
      $(".disct-code-box .no-match-disct").hide();
      if (
        cart.cart_level_discount_applications.length > 0 &&
      ...
      // 价格计算相关
      dropdownCart
        .find(".summary .total-original_price")
        .html(
          Shopify.formatMoney(cart.original_total_price, window.money_format)
        );
      dropdownCart
        .find(".summary .subtotal-price")
        .html(
          Shopify.formatMoney(cart.items_subtotal_price, window.money_format)
        );
      if (cart.original_total_price == cart.items_subtotal_price) {
        dropdownCart.find(".summary .total-original_price").hide();
      } else {
        dropdownCart.find(".summary .total-original_price").show();
      }
      dropdownCart
        .find(".summary .discounted-price")
    ...
    // 初始化折扣码输入框
    initDiscountBox() {
      let apply_btn = $(".apply-disct-btn");
      apply_btn.click(function () {
        let discount_code = $(this).prev().val().trim();
        if (!!discount_code) {
          ella.applyDiscountCode(discount_code, this);
        }
      });
    },
    // 初始化计数器功能,callback: 当计数器改变后执行的回调函数
    initNumberInput(el, callback) {
      var btnUpdate = el.find(".input-number");
      btnUpdate.on("input", function () {
        var input = $(this);
        let value = input.val();
      ...
      ella.initDecrAndIncrBtn();
    },
    // 侧边栏购物车输入框数字改变的监听和防抖处理
    dropdownCartQuantityChange(input) {
      clearTimeout(ella.inputChangeTimeOut);
      ella.inputChangeTimeOut = setTimeout(function () {
        var id = input.closest("[data-product-id]").data("product-id");
        var quantity = parseInt(input.val());
        input.parents(".item").addClass("cur--change");
    ...
    // 详情页等公共锚点初始化
    initScrollAnchor() {
      $("[scroll-anchor-link]").on("click", function (e) {
        let btn_link = $(this).attr("scroll-anchor-link");
        $("html, body").animate(
          {
            scrollTop: $("#" + btn_link).offset().top - 100,
          },
          1000
        );
        return false;
    ...
    initStickyCheckout() {
      let option_btn = $(".btn-actions .btn-checkout.on-page");
      let sticky_btn = $(".btn-actions .option-btn.sticky-btn");
      let elementHeight = option_btn.outerHeight();
      $(window).scroll(function () {
        var elementOffset = option_btn.offset().top;
        var windowHeight = $(window).height();
        var scrollPosition = $(window).scrollTop();
        if (
          (elementOffset + elementHeight > scrollPosition &&
            elementOffset < scrollPosition + windowHeight) ||
          scrollPosition + windowHeight + 100 >= $(document).height()
        ) {
          // 元素在可视区域内，恢复正常样式
          sticky_btn.removeClass("open-sticky");
        } else {
          // 元素不在可视区域内，吸底展示
          sticky_btn.addClass("open-sticky");
        }
      });
    },
    openRemindLoginPop: function (remindLoginPop) {
      remindLoginPop.fadeIn(500);
    },

    closeRemindLoginPop: function (remindLoginPop, expire = 1) {
      remindLoginPop.fadeOut(500);
      $.cookie("remindLoginModal", "closed", {
        expires: expire,
        path: "/",
      });
    },
    // 初始化提示登录的弹框
    initRemindLoginPop: function () {
      let remindLoginPop = $(".remind-login-pop");
      let in_showpage = false;
      let closeBtn = $(".remind-login-pop .close-btn");
      const currentUrl = window.location.pathname;
      // 只在首页自动弹出
      if (currentUrl === "/") {
        in_showpage = true;
      ...
      closeBtn.on("click", function () {
        ella.closeRemindLoginPop(remindLoginPop, 1);
      });
      if ($.cookie("remindLoginModal") != "closed" && in_showpage) {
        ella.ellaTimeout = setTimeout(function () {
          ella.openRemindLoginPop(remindLoginPop);
          setTimeout(function () {
            ella.closeRemindLoginPop(remindLoginPop, 1);
          }, 8000);
        }, 2000);
    ...
    initTextareaCount(){
      ...
      if($formTextarea.length > 0){
        $formTextarea.each((index,item)=>{
          const $textarea = $(item).find('textarea');
          const $wordCount = $(item).find('.textarea-word-count').find('.current-count');
    ...
    initCustomLinkBtn() {
      $("[custom-link-btn]").on("click", function () {
        const url = $(this).data("url");
        window.location.href = url;
      });
    },
    // 对指定class的带href="#"的a标签进行默认禁用
    disableHashLinks: function () {
      let filterClass = [
        "close-search",
        "close-modal",
        "close-customer",
      ...
      links.forEach(function (link) {
        ...
        const shouldDisable = filterClass.some((className) =>
    ...
    liveValidate: function() {
      ...
      function createErrorMessage($field, message) {
        // 检查是否已存在错误提示
        let $error = $field.next(".validation-error");
        if ($error.length === 0) {
          $error = $("<span>", {
            class: "validation-error text-red-500 text-sm mt-1 block hidden",
            role: "alert"
          }).insertAfter($field);
        }
        $error.text(message);
      ...
      function validateField($field) {
        // 如果还未交互过，不进行验证
        if (!$field.data('interacted')) {
          return true;
        }
        
        const fieldValue = $field.val().trim();
        const fieldType = $field.data("validate");
        const isRequired = $field.prop("required") || $field.data("required");
        let isValid = true;
        let errorMessage = "";
        
        // 处理必填验证
        if (isRequired && !validationRules.required.pattern.test(fieldValue)) {
          isValid = false;
          errorMessage = validationRules.required.message;
        } 
        // 处理特定类型验证（非空时）
        else if (fieldValue && validationRules[fieldType]) {
          if (!validationRules[fieldType].pattern.test(fieldValue)) {
            isValid = false;
        ...
        $field.toggleClass("border-red-500", !isValid)
              .toggleClass("border-green-500", isValid && fieldValue);
        $error.toggleClass("hidden", isValid);
        // 触发自定义事件
      ...
      $fields.each(function() {
        ...
        function markAsInteracted() {
          $field.data('interacted', true);
          validateField($field);
        }
        
        // 仅在用户交互后才进行验证
        $field.on("input", markAsInteracted)
              .on("blur", markAsInteracted);
      });
    }
  };
})(jQuery);
