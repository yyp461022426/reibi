...
class CollectionFiltersForm extends HTMLElement {
  constructor() {
    ...
    let close_elem = document.querySelectorAll('.close--list_tags');
    if(elem) {
      elem.forEach( (button) => button.addEventListener('click', this.showMoreValue.bind(this)));
    }
    if(close_elem) {
      close_elem.forEach( (button) => button.addEventListener('click', this.closeMoreValue.bind(this)));
    }
  }
  ...
  closeMoreValue(e) {
    e.target.closest('.list-tags').classList.remove('full');
